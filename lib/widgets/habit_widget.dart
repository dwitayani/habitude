                  ...
                  children: [
                    ...
                    Column(
                        children: List.generate(
                            (widget.habit.data()!['mappings'] ?? []).length,
                            (index) {
                      Map<String, dynamic> map =
                          widget.habit.data()!['mappings'][index];
                      if (map['value'] == null &&
                          map['key'] == DateFormat('yyyyMMdd').format(today)) {
                        return Row(
                            ...
                            TextButton(
                              onPressed: () async {
                                await FirebaseFirestore.instance
                                    ...
                                    .doc(widget.habit.id)
                                    .update({
                                  'mappings': FieldValue.arrayRemove([map])
                                });
                                await FirebaseFirestore.instance
                                    .collection('habits')
                                    .doc(widget.habit.id)
                                    .update({
                                  'mappings': FieldValue.arrayUnion([
